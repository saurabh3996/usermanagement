...
public class SellerController {
	...
	public ResponseEntity<String> registerBuyer(@RequestBody Seller seller) {
	...
	public ResponseEntity<String> getSellerDetails(@RequestParam(name = "email") String email) {
